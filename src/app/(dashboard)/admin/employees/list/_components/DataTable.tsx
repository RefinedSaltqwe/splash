...
import { DataTableFilters } from "@/app/(dashboard)/admin/employees/list/_components/DataTableFilters";
...
const extractRowIds = (rows: number[], users: User[]) => {
            ...
            >
              ...
              <div className="ml-2 h-auto w-6 rounded-md bg-red-500/20">
                <span className="text-red-500">
                  {users.filter((user) => user.status === "Terminated").length}
                </span>
              </div>
            </TabsTrigger>
          </TabsList>
