...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative isolate pt-14">
      ...
      >
        <div
          className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#3c82f6] to-[#6da8f4] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Splash Innovations helps you save time and energy, allowing you to
              prioritize what truly counts – nurturing your team, enhancing the
              employee journey, and propelling your business to greater heights.
            </p>
          ...
          >
            <div className="-m-2 rounded-xl bg-foreground/5 p-2 ring-1 ring-inset ring-foreground/10 lg:-m-4 lg:rounded-2xl lg:p-4">
              {mode === "dark" ? (
                <Image
                  src={"/assets/images/preview-dark.jpg"}
                  alt="App screenshot"
                  width={2432}
                  height={1442}
                ...
                <Image
                  src={"/assets/images/preview-light.jpg"}
                  alt="App screenshot"
                  width={2432}
                  height={1442}
                  className="rounded-md shadow-2xl ring-1 ring-foreground/10"
