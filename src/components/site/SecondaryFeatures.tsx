...
import screenshotContacts from "../../../public/assets/images/contacts.png";
import screenshotInventory from "../../../public/assets/images/inventory.png";
import screenshotProfitLoss from "../../../public/assets/images/profit-loss.png";
...
export default function SecondaryFeatures() {
  return (
    <section
      ...
      className="bg-white pb-14 pt-20 sm:pb-20 sm:pt-32 lg:pb-32"
    >
      <Container>
