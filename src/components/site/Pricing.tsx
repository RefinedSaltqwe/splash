...
const sections = [
  {
    ...
    features: [
      {
        name: "Tax Savings",
        tiers: { Starter: "true", Unlimited: "true", Basic: "true" },
      },
      {
      ...
      },
      {
        ...
        tiers: { Starter: "false", Unlimited: "true", Basic: "true" },
      },
      {
      ...
      },
      {
        ...
        tiers: { Starter: "false", Unlimited: "true", Basic: "false" },
      },
    ],
  },
  {
            ...
            >
              ...
              <defs>
                <radialGradient id="d25c25d4-6d43-4bf9-b9ac-1842a30a4867">
                  ...
                  <stop offset={1} stopColor="#6ba8f4" />
                </radialGradient>
              </defs>
            </svg>
            <div
              ...
              aria-hidden="true"
            />
            {prices.data.map((tier) => (
              <div
                key={tier.id}
                className={cn(
                  tier.nickname === "Unlimited"
                ...
                <div className="p-8 lg:pt-12 xl:p-10 xl:pt-14">
                  ...
                  <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                    <div className="mt-2 flex items-center gap-x-4">
                      ...
                      >
                        {tier.unit_amount && tier.unit_amount / 100}
                      </p>
                    ...
                    {tier.nickname === "Starter" ? (
                      ...
                      <a
                        href={`/admin?plan=${tier.id}`}
                        aria-describedby={tier.id}
                        className={cn(
                          tier.nickname === "Unlimited"
                            ? "bg-primary shadow-sm hover:bg-primary focus-visible:outline-primary"
                            : "bg-white/10 hover:bg-white/20 focus-visible:outline-white",
                          "rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
                        )}
                      >
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          ...
          >
            ...
            <div className="mx-auto max-w-2xl space-y-16">
              {prices.data.map((tier) => {
                const name: string = tier.nickname ?? "Starter";
                return (
                  <div key={tier.id} className="border-t border-gray-900/10">
                    ...
                    >
                      ...
                      <p className="mt-1 text-sm leading-6 text-gray-600">
                        {
                          pricingCards.find((c) => c.title === tier.nickname)
                            ?.description
                        }
                      </p>
                    </div>
                                ...
                                {section.features.map((feature) => (
                                  ...
                                  >
                                    ...
                                    <dd className="flex items-center justify-end sm:justify-center sm:px-4">
                                      {!["true", "false"].includes(
                                        feature.tiers[name as keyof Tiers],
                                      ) ? (
                                        <span
                                          className={
                                            tier.nickname === "Unlimited"
